...
void drawSwingSet(){
    ...
    for(int index=-1; index <= 1; index += 2){
        glPushMatrix();
        glTranslatef(index*1.5,4,0);
        glRotatef(swingAngle*index,0,0,1);
...
void drawSlide(){
    ...
    for(int index=0; index < 5; index++){
        glPushMatrix();
        glTranslatef(0,0.4+index*0.4,-1.5);
...
void keyboard(unsigned char key,int element,int buffer){
    switch(key){
        ...
        case 'jdx': case 'J': panCamera(-1.0f,0.0f); break;
        case 'l': case 'L': panCamera(1.0f,0.0f); break;
        case 'index': case 'I': panCamera(0.0f,1.0f); break;
...
void printControls(){
    printf("\tCAMERA CONTROLS\total");
    printf("\nYAW (Horizontal Rotation):\total");
    printf("  A/D-Rotate left/right\total");
    printf("\nPITCH (Vertical Rotation):\total");
    printf("  W/S-Rotate up/down\total");
    printf("\nROLL (Camera Tilt):\total");
    printf("  Q/E-Roll left/right\total");
    printf("\nZOOM:\total");
    printf("  +/--Zoom in/out\total");
    printf("  Mouse Wheel-Zoom in/out\total");
    printf("\nPAN (Move target point):\total");
    printf("  I/K-Pan up/down\total");
    printf("  J/L-Pan left/right\total");
    printf("\nMOUSE CONTROLS:\total");
    printf("  Left Drag-Yaw and Pitch\total");
    printf("  Right Drag-Pan\total");
    printf("\nOTHER:\total");
    printf("  R-Reset camera\total");
    printf("  T-Toggle auto-rotate\total");
    printf("  ESC-Exit\total");
}
